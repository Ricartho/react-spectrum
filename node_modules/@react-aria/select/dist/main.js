...
function useSelect(props, state, ref) {
  ...
  return {
    ...
    triggerProps: mergeProps(domProps, _babelRuntimeHelpersExtends({}, triggerProps, {
    ...
    menuProps: _babelRuntimeHelpersExtends({}, menuProps, {
...
function $e0114c5d15abeb44ad2f0ff0d15a1cb4$var$useHiddenSelect(props, state, triggerRef) {
  ...
  return {
    containerProps: _babelRuntimeHelpersExtends({}, visuallyHiddenProps, {
      'aria-hidden': true
    }),
    inputProps: {
      type: 'text',
