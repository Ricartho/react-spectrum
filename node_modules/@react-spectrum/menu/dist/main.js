...
const $edd9ab002cde8b9b98bf7ac7e2372c8e$export$MenuContext = _react.createContext({});
...
function $c4892d994b65f49f4dea95880128b38$var$MenuTrigger(props, ref) {
  ...
  let menuContext = _babelRuntimeHelpersExtends({}, menuProps, {
    ref: menuRef,
    onClose: state.close,
    closeOnSelect,
  ...
  return /*#__PURE__*/_react.createElement(Fragment, null, /*#__PURE__*/_react.createElement(PressResponder, _babelRuntimeHelpersExtends({}, menuTriggerProps, {
    ref: menuTriggerRef,
...
let MenuTrigger = forwardRef($c4892d994b65f49f4dea95880128b38$var$MenuTrigger);
exports.MenuTrigger = MenuTrigger;

/** @private */
function $c7f2f7472da9591348da844617ffa5d9$export$MenuItem(props) {
  let {
    item,
    state,
    isVirtualized,
  ...
  let {
    onClose,
    closeOnSelect
  } = $edd9ab002cde8b9b98bf7ac7e2372c8e$export$useMenuContext();
  let {
    rendered,
    key
  } = item;
  ...
  }, /*#__PURE__*/_react.createElement("li", _babelRuntimeHelpersExtends({}, mergeProps(menuItemProps, hoverProps), {
    ref: ref,
...
/** @private */
function $c0ff64d7a4e982f233f34aa6c4a1bc$export$MenuSection(props) {
  let {
    item,
    state,
    onAction
  ...
  return /*#__PURE__*/_react.createElement(Fragment, null, item.key !== state.collection.getFirstKey() && /*#__PURE__*/_react.createElement("li", _babelRuntimeHelpersExtends({}, separatorProps, {
    className: classNames($bfbcd6bc836614813c70085787fd$$interop$default, 'spectrum-Menu-divider')
  })), /*#__PURE__*/_react.createElement("li", itemProps, item.rendered && /*#__PURE__*/_react.createElement("span", _babelRuntimeHelpersExtends({}, headingProps, {
    className: classNames($bfbcd6bc836614813c70085787fd$$interop$default, 'spectrum-Menu-sectionHeading')
  }), item.rendered), /*#__PURE__*/_react.createElement("ul", _babelRuntimeHelpersExtends({}, groupProps, {
    className: classNames($bfbcd6bc836614813c70085787fd$$interop$default, 'spectrum-Menu')
  }), [...item.childNodes].map(node => {
    let item = /*#__PURE__*/_react.createElement($c7f2f7472da9591348da844617ffa5d9$export$MenuItem, {
      key: node.key,
      item: node,
      state: state,
      onAction: onAction
...
function $be3a5c916828e33faf8ffa30483fbe6$var$Menu(props, ref) {
  ...
  let completeProps = _babelRuntimeHelpersExtends({}, mergeProps(contextProps, props));
  ...
  return /*#__PURE__*/_react.createElement("ul", _babelRuntimeHelpersExtends({}, menuProps, styleProps, {
    ref: domRef,
    className: classNames($bfbcd6bc836614813c70085787fd$$interop$default, 'spectrum-Menu', styleProps.className)
  }), [...state.collection].map(item => {
    if (item.type === 'section') {
      return /*#__PURE__*/_react.createElement($c0ff64d7a4e982f233f34aa6c4a1bc$export$MenuSection, {
        key: item.key,
        item: item,
        state: state,
...
const Menu = _react.forwardRef($be3a5c916828e33faf8ffa30483fbe6$var$Menu);
