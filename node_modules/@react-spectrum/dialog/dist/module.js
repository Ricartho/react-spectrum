...
import _react, { useContext, useRef, forwardRef, Fragment } from "react";
...
const $cbd214e8f430cad55f170202f58e419$export$DialogContext = _react.createContext(null);
...
function $ae0ae5ec87ff1f7a54fe4ae25e$var$Dialog(props, ref) {
  ...
  return /*#__PURE__*/_react.createElement(FocusScope, {
    ...
    onPress: onDismiss
  }, /*#__PURE__*/_react.createElement(_spectrumIconsUiCrossLarge, {
    size: "L"
  }))), dismissButton));
}
/**
...
export let Dialog = _react.forwardRef($ae0ae5ec87ff1f7a54fe4ae25e$var$Dialog);
// @ts-ignore
...
export let AlertDialog = forwardRef($a3dd0910feda015a44956582ca4d4997$var$AlertDialog);
